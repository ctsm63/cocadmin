...
def main():
    ...
    parser = argparse.ArgumentParser(description="Tester un nombre donné d'appels HTTP à une URL générée.")
    parser.add_argument("count", nargs="?", type=int, default=1000, help="Nombre d'appels HTTP (par défaut: 1000)")
